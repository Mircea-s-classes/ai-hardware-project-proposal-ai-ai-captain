...
**Semester:** Fall 2025  
**Proposal Deadline:** December 9, 2025 — 11:59 PM  
...
- **2–3 presentation slides** for the December 9 in-class presentation.
...
| Dec 9,2025 (in class)   | Midterm-style progress                      | OpenMV doing capture → features → class      |
